...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _login() async {
    ...
    if (response.success) {
      AppToast.show(context, 'Welcome back! Shift portal ready.',
          isSuccess: true);
  ...
  Widget _buildForm(AuthProvider auth) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: cardShadow(opacity: 0.07, blur: 32),
      ),
      child: Form(
        key: _formKey,
        child: Column(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Positioned(
              top: -100, right: -100, child: _Ring(size: 380, opacity: 0.07)),
          Positioned(
              bottom: -80, left: -80, child: _Ring(size: 320, opacity: 0.06)),
          Positioned(
              top: 220, left: 40, child: _Ring(size: 140, opacity: 0.05)),
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: const [
                    ...
                    _FeaturePill(
                        icon: Icons.timer_rounded, label: 'Shift Timer'),
                    _FeaturePill(
                        icon: Icons.table_chart_rounded,
                        label: 'Timesheet Reports'),
                    _FeaturePill(
                        icon: Icons.sync_rounded, label: 'Offline Sync'),
                  ],
                ),
                const SizedBox(height: 48),
                const Row(
